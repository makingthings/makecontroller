...
typedef struct tskTaskControlBlock
{
  ...
  // MakingThings
  struct sys_timeouts timeouts; // better incorporate LWIP
  void* context;                // a cookie to keep some context - we use it to keep a pointer to the containing Task object
  // end MakingThings
