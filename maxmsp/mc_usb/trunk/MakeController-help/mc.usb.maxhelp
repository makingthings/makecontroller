	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"presentation_rect" : [ 623.0, 310.0, 0.0, 0.0 ],
					"id" : "obj-3",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 25.0, 69.0, 450.0, 276.0 ],
						"bgcolor" : [ 0.858824, 0.921569, 1.0, 1.0 ],
						"bglocked" : 0,
						"defrect" : [ 25.0, 69.0, 450.0, 276.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Why use s and r to pass around messages to and from the Make Controller?\n\nWell, there's only one Make Controller so there's only one mc.usb object.  But it's often not very convenient to connect patch cables between mc.usb and all the different places you want to use it.\n\nSo, if you stick to the convention used in the help patches and always send and receive from the same names, even if your new mc.usb is not successfully created (because another one already exists), you'll still be getting good info to and from it via send and receive.",
									"linecount" : 11,
									"fontsize" : 12.0,
									"id" : "obj-5",
									"numinlets" : 1,
									"fontname" : "Arial",
									"patching_rect" : [ 22.0, 74.0, 394.0, 158.0 ],
									"numoutlets" : 0
								}
